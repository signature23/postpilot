    ...
    return (
        <section className='bg-[#FDF3EA]'>
            <div className='container py-6 mx-auto'>
                ...
                <div className='flex flex-col p-6 md:grid-cols-2 md:grid-rows-3 md:gap-2 md:grid'>


                    <div className=''>
                        <div>
                            <p className='text-center text-[25px] leading-none py-10 md:text-[40px] md:text-start md:leading-1' ><span className='text-[#009387] font-Grace'>Powerful</span> acquisition & retention</p>
                    ...
                    <div className='md:col-start-2 md:row-start-2'>
                        <div>
                            <p className='text-center text-[25px] leading-none py-10 md:text-[40px] md:text-start  md:leading-1' ><span className='text-[#009387] font-Grace'>Fight back</span>  against iOS updates, jacked-up CPCs & spam folders</p>
                    ...
                    <div className='md:row-start-3'>
                        <div>
                            <p className='text-center text-[25px] leading-none py-10 md:text-[40px] md:text-start  md:leading-1' > Done for <span className='text-[#009387] font-Grace'>you</span></p>
                            <p className='text-[#58595D] my-4'>Deliver your message to all of your customers — for less than the cost of a click.</p>

                            <div className='relative p-6 mb-4 border-2 border-gray-300 rounded-sm'>
